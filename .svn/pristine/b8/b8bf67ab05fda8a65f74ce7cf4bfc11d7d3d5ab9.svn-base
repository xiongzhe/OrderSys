...
-(UIView *)dateLabelContainer
{
    if(!_dateLabelContainer){
        ...
        _dateLabelContainer.layer.borderWidth = 1;
        _dateLabelContainer.layer.borderColor = [RGBColorWithoutAlpha(240, 111, 90) CGColor];
...
-(UILabel *)dateLabel
{
    if(!_dateLabel){
        ...
        _dateLabel.textColor = RGBColorWithoutAlpha(240, 111, 90);
...
//    }
    if (blnSelected) {
        self.dateLabelContainer.backgroundColor = RGBColorWithoutAlpha(240, 111, 90);
        self.dateLabel.textColor = [UIColor whiteColor];
    }else{
        self.dateLabelContainer.backgroundColor = [UIColor clearColor];
        self.dateLabel.textColor = RGBColorWithoutAlpha(240, 111, 90);
    }
